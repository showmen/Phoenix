...
<body>
    <div class="logo">
        <h4><a href="index.htm">Light <strong>Blue</strong></a></h4>
    </div>
        <nav id="sidebar" class="sidebar nav-collapse collapse">
            <ul id="side-nav" class="side-nav">
                <li class="active">
                    <a href="index.htm"><i class="fa fa-home"></i> <span class="name">Dashboard</span></a>
                </li>
                <li class="panel ">
                    ...
                    <ul id="forms-collapse" class="panel-collapse collapse ">
                        <li class=""><a href="form_account.htm">Account</a></li>
                        <li class=""><a href="form_article.htm">Article</a></li>
                        <li class=""><a href="form_elements.htm">Elements</a></li>
                        <li class=""><a href="form_validation.htm">Validation</a></li>
                        <li class=""><a href="form_wizard.htm">Wizard</a></li>
                    </ul>
                </li>
                <li class="panel ">
                    ...
                    <ul id="stats-collapse" class="panel-collapse collapse ">
                        <li class=""><a href="stat_statistics.htm">Stats</a></li>
                        <li class=""><a href="stat_charts.htm">Charts</a></li>
                        <li class=""><a href="stat_realtime.htm">Realtime</a></li>
                    </ul>
                </li>
                <li class="panel ">
                    ...
                    <ul id="ui-collapse" class="panel-collapse collapse ">
                        <li class=""><a href="ui_buttons.htm">Buttons</a></li>
                        <li class=""><a href="ui_dialogs.htm">Dialogs</a></li>
                        <li class=""><a href="ui_notifications.htm">Notifications</a></li>
                        <li class=""><a href="ui_icons.htm">Icons</a></li>
                        <li class=""><a href="ui_tabs.htm">Tabs</a></li>
                        <li class=""><a href="ui_accordion.htm">Accordion</a></li>
                    </ul>
                </li>
                <li class="panel ">
                    ...
                    <ul id="components-collapse" class="panel-collapse collapse ">
                        <li class=""><a href="component_calendar.htm">Calendar</a></li>
                        <li class=""><a href="component_maps.htm" data-no-pjax="">Maps</a></li>
                        <li class=""><a href="component_gallery.htm">Gallery</a></li>
                        <li class=""><a href="component_fileupload.htm" data-no-pjax="">Fileupload</a></li>
                        <li class=""><a href="component_bootstrap.htm">Bootstrap</a></li>
                        <li class=""><a href="component_list_groups.htm">List Groups</a></li>
                    </ul>
                </li>
                <li class="panel ">
                    ...
                    <ul id="tables-collapse" class="panel-collapse collapse ">
                        <li class=""><a href="tables_static.htm">Static <sup class="text-danger fw-bold">upd</sup></a></li>
                        <li class=""><a href="tables_dynamic.htm">Dynamic</a></li>
                    </ul>
                </li>
                <li class="panel ">
                    ...
                    <ul id="grid-collapse" class="panel-collapse collapse ">
                        <li class=""><a href="grid_basic.htm">Basic</a></li>
                        <li class=""><a href="grid_live.htm">Live</a></li>
                    </ul>
                </li>
                <li class="panel ">
                    ...
                    <ul id="special-collapse" class="panel-collapse collapse ">
                        <li class=""><a href="special_search.htm">Search <sup class="text-warning fw-bold">new</sup></a></li>
                        <li class=""><a href="special_invoice.htm">Invoice</a></li>
                        <li class=""><a href="special_inbox.htm">Inbox &nbsp; <span class="label label-important">3</span></a></li>
                        <li><a target="_blank" href="login.htm">Login</a></li>
                        <li><a target="_blank" href="error.htm">Error Page</a></li>
                        <li><a href="landing.htm" data-no-pjax="">Landing</a></li>
                ...
                <li class="visible-xs">
                    <a href="login.htm"><i class="fa fa-sign-out"></i> <span class="name">Sign Out</span></a>
                </li>
            </ul>
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="hidden-xs dropdown">
                        ...
                        <ul id="account-menu" class="dropdown-menu account" role="menu">
                            ...
                            <li role="presentation">
                                <a href="form_account.htm" class="link">
                                    <i class="fa fa-user"></i>
                                    Profile
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="component_calendar.htm" class="link">
                    ...
                    <li class="hidden-xs"><a href="login.htm"><i class="glyphicon glyphicon-off"></i></a></li>
                </ul>
                            ...
                            <div id="chat-messages" class="chat-messages">
                                ...
                                <div class="chat-message">
                                    <div class="sender pull-right">
                                        <div class="icon">
                                            <img src="{{asset('img\1.png')}}" class="img-circle" alt="">
                                        </div>
                                        <div class="time">
                                            3 min
                                        </div>
                    ...
                    <div class="body">
                        <div id="feed" class="feed">
                            <div class="wrapper">
                                ...
                                <section class="feed-item">
                                    <div class="icon pull-left">
                                        <img src="{{asset('img\14.png')}}" class="img-circle" alt="">
                                    </div>
                                    <div class="feed-item-body">
                                        <div class="text">
                ...
                <section class="widget widget-tabs">
                    ...
                    <div class="body tab-content">
                        <div id="stats" class="tab-pane active clearfix">
                            ...
                            <ul class="news-list">
                                <li>
                                    <img src="{{asset('img\1.png')}}" alt="" class="pull-left img-circle">
                                ...
                                <li>
                                    <img src="{{asset('img\3.png')}}" alt="" class="pull-left img-circle">
                                    <div class="news-item-info">
                                ...
                                <li>
                                    <img src="{{asset('img\2.png')}}" alt="" class="pull-left img-circle">
                                    <div class="news-item-info">
                                ...
                                <li>
                                    <img src="{{asset('img\13.png')}}" alt="" class="pull-left img-circle">
                                    <div class="news-item-info">
                                ...
                                <li>
                                    <img src="{{asset('img\14.png')}}" alt="" class="pull-left img-circle">
                                    <div class="news-item-info">
...
<script src="{{asset('lib\bootstrap-sass\asset\javascripts\bootstrap.min.js')}}"></script>
